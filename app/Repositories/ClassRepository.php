...
class ClassRepository implements ClassInterface
{
    ...
    public function getUsersByClass(
        string $kelas
    ) {
        $class = DB::table('classes')
            ->where('name', $kelas)
